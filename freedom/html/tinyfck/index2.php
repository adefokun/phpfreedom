...
<form method="post" action="">
	<textarea id="elm1" name="elm1" rows="30" cols="80" style="width: 100%">
	</textarea>	
	
	<input type="button" name="submit" value="Submit" onclick="alert(document.getElementById('elm1').getContent())"/>
</form>
